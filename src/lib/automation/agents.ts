...
export const AUTOMATION_AGENTS: readonly AutomationAgent[] = [
  {
    ...
    iconSlug: "claude",
    docsUrl: "https://support.claude.com/en/articles/9517075-what-are-projects",
  },
  {
    ...
    kind: AUTOMATION_AGENT_KIND.CHAT,
    docsUrl: "https://help.openai.com/en/articles/8096356-chatgpt-custom-instructions",
  },
  {
    ...
    docsUrl: "https://support.google.com/gemini/answer/16598625",
  },
  {
  ...
  },
  {
    ...
    kind: AUTOMATION_AGENT_KIND.CODING,
    iconSlug: "cline",
    docsUrl: "https://docs.cline.bot/features/cline-rules/overview",
  },
  {
